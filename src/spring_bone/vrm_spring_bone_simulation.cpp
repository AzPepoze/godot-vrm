...
void VRMSpringBoneSimulation::_bind_methods() {
  ...
  ADD_PROPERTY(PropertyInfo(Variant::INT, "gizmo_display_mode",
                            PROPERTY_HINT_ENUM, "Line Circle,Capsule"),
  ...
  ClassDB::bind_method(
      D_METHOD("get_joint_prev_tail", "chain_idx", "joint_idx"),
...
void VRMSpringBoneSimulation::draw_gizmo(Object *p_mesh_obj,
  ...
  SpringBoneGizmo::draw_gizmo(mesh, skel, p_skel_to_gizmo, chains,
                              all_colliders, recent_impacts, params);
}
