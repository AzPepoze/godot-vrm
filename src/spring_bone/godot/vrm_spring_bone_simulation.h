...
private:
  std::vector<SpringBoneTypes::Chain> chains;
  std::vector<SpringBoneTypes::Collider> all_colliders;
  std::vector<SpringBoneTypes::ColliderGroup> all_collider_groups;
  std::vector<SpringBoneTypes::CollisionImpact> recent_impacts;
  bool is_setup = false;
...
private:
  ...
  void _resolve_angular_collisions(Skeleton3D *skel, const Transform3D &center,
                                   ...
                                   SpringBoneTypes::Chain &chain,
                                   SpringBoneTypes::Joint &joint,
